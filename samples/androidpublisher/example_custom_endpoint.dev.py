...
def main():
    ...
    # ============================================================
    global kid, private_key_pem, client_id
    service_account_file = os.path.join(
        '/Users/nunoforvia/workspace/product_cluster/web-product-service/tests/appning-apiclient-php-package/examples/kid-private-key.json'
    )
